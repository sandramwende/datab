...
<head>
	...
	<title>My Practice - Sign Up</title>
...
<script src="assets/demo/demo.js"></script>
	...
	<!-- Page background -->
	<div id="page-signup-bg"></div>
	
	<div class="signup-container">
		<div class="signup-header" style="background-color: red">
			<a href="index.php" class="logo">
				AFRICAN NAZERENE UNIVERSITY<span style="font-weight:50;"> </span>
			</a> 
			<div class="slogan">
				For you by you.
			</div> 
